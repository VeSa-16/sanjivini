    ...
    <>
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[230px] border-r border-[#173f2c]/8 bg-[#f4f3ea]/90 p-5 backdrop-blur-xl lg:block">
        <div className="flex items-center gap-3 px-2 py-2">
          <div className="grid size-11 place-items-center rounded-[18px] bg-[#173f2c] font-serif text-xl font-bold text-white shadow-lg shadow-[#173f2c]/15">S</div>
          <div>
            <div className="font-serif text-xl font-bold leading-none text-[#173f2c]">Sanjivani</div>
            <div className="mt-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#7f897f]">Crop companion</div>
          </div>
        </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 mx-auto border-t border-[#173f2c]/8 bg-[#fbfbf7]/92 px-3 pb-[max(10px,env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl lg:hidden">
